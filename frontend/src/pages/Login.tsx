      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ textAlign: "right" }}>
            <span style={{ fontSize: "12px", color: "#C3A69D", cursor: "pointer" }}>Forgot password?</span>
          </div>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "60px", maxWidth: "440px" }}>
          ...
          <h2 style={{ fontSize: "48px", fontWeight: "700", color: "#2d2d2d", lineHeight: 1.1, margin: "0 0 24px" }}>
            Shop.<br/>
            <span style={{ color: "#9DC3C2" }}>Discover.</span><br/>
            Enjoy.
          </h2>
          <p style={{ fontSize: "15px", color: "#555", lineHeight: 1.7, margin: "0 0 36px" }}>
            Thousands of products curated for you. From everyday essentials to something special — mintTech has it all.
          </p>

          {/* Stats */}
          <div style={{ display: "flex", gap: "32px" }}>
            {[["500+", "Products"], ["24/7", "Support"], ["100%", "Secure"]].map(([num, label]) => (
              <div key={label}>
                <div style={{ fontSize: "22px", fontWeight: "700", color: "#2d2d2d" }}>{num}</div>
